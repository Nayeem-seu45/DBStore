...
namespace DBStore.DataAccess.Data.Service
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailForEmailConfirmation(UserEmailOption userEmailOptions)
        {
        ...
        public async Task SendEmailForForgotPassword(string email, UserEmailOption userEmailOptions)
        {
